...
export const Editpage = () => {
    ...
    const requestingUrl = `/adminpanel/modify/${linkId}`
    ...
    const upload = ({target: {files}}) => {
        ...
        data.append('title', information.title)
        data.append('description', information.description)
        data.append('price', information.price)
    ...
    return (
        <div className="container">
            <h1 className="adminpanel courses info">Course edit page</h1>
            <div className="content">
                <form className="modify form" onSubmit={sendData}>
                    <div className="form-control">
                        <label htmlFor="title">Course title: </label>
                        <input type="text" id="title" placeholder="Course title..." name="title" required={true} value={information.title} onChange={handleChanges}/>
                    </div>
                    <div className="form-control">
                        <label htmlFor="price">Course price: </label>
                        <input type="number" id="price" placeholder="Course price in '$' ..." name="price" required={true} value={information.price} onChange={handleChanges}/>
                    </div>
                    <div className="form-control">
                        <label htmlFor="description">Course description: </label>
                        <textarea name="description" id="description" maxLength={100} placeholder="Max 100 symbols..." value={information.description} required={true} onChange={handleChanges}/>
                    </div>
                    <div className="form-control">
                        <label htmlFor="course">Course image: </label>
